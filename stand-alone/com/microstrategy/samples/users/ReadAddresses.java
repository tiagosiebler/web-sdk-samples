...
public class ReadAddresses {
	...
	public static void main(String[] args) {
		...
		try {
			String userObjectID = "A69FE9944C16237E19C2BAAB320CC0F3";
			WebUser user = (WebUser) source.getObject(userObjectID, EnumDSSXMLObjectTypes.DssXmlTypeUser);
			...
			// currentSubscriptionAddress can only be used to store one specific element, so
			// a for loop was created to
			// search through all WebSubScriptionAddresses (Delivery Sources) and print out
			// the name and Email of all non-empty Email addresses
